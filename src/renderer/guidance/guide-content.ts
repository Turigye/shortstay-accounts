...
export const guideChapters: GuideChapter[] = [
  ...
  },
  {
    ...
    sections: [
      { heading: "Collections and receipts", paragraphs: ["Choose the account and booking when recording a receipt. Partial payments leave an outstanding balance; payment allocation keeps each booking balance accurate.", "The receipt opens after an incoming payment is saved. Use Print receipt for an installed printer or Save PDF for a shareable file. Reopen it later with the printer button in payment history.", "Cancelling a booking does not erase money already received. Record a refund when money is returned. Use a reversal or correction for recording mistakes so the ledger stays auditable."] },
      { heading: "Costs and suppliers", paragraphs: ["Add Visa or another card in Settings > Accounts, then choose it when recording the expense. Supplier credit records an amount due for later supplier payment.", "For Netflix, Yaka service fees, and similar costs, open Expenses > Recurring bills > Add recurring bill, choose how often it repeats, and confirm the real bill when due."] },
    ],
  },
  {
  ...
  },
  {
    ...
    sections: [
      { heading: "Financial position", paragraphs: ["Review cash and account balances, receivables, guest-supply inventory, assets, loans, payables, and owner equity. The position is balanced when total assets equal liabilities plus equity.", "For land, buildings, renovations, furniture, and equipment, add each item under Assets at historical cost and choose Owner, Loan, Business income, or Mixed funding. Investment is not rental income.", "Open Investment Recovery to compare owner-funded cost with cumulative revenue and net income. The remaining amount falls only as the business generates positive net income, so normal operating costs are not ignored.", "Use the pencil action to correct an asset or loan. A loan can record annual interest, repayment frequency, installment amount, term, due date, and outstanding balance."] },
