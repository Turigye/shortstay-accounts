...
export const tourDefinitions: TourDefinition[] = [
  ...
  { id: "bookings", title: "Booking Lifecycle", summary: "Enter, monitor, and complete manual stays.", steps: [
    ...
    { id: "booking-editor", screen: "bookings", target: "booking-editor", title: "Enter stay details", body: "Choose customer and unit, dates, nightly rate, and referral details." },
    { id: "booking-status", screen: "bookings", target: "booking-status", title: "Follow the lifecycle", body: "Move from Draft through Confirmed, Checked in, and Completed, or cancel when needed." },
    { id: "booking-archive", screen: "bookings", target: "booking-archive", title: "Keep records tidy", body: "Edit facts when needed and archive records that no longer belong in daily lists." },
  ] },
  { id: "money", title: "Money In and Money Out", summary: "Record money movements with a traceable history.", steps: [
    ...
    { id: "payment-history", screen: "payments", target: "payment-history", title: "Correct transparently", body: "Refunds, reversals, and corrections preserve the audit trail rather than erase history." },
  ...
  { id: "staff", title: "Staff and Referrals", summary: "Explain every earned and paid allocation.", steps: [
    ...
    { id: "staff-rates", screen: "staff", target: "staff-rates", title: "Review six allocations", body: "The six default rates total 37%: 5%, 5%, 10%, 2%, 5%, and 10%." },
    { id: "referral-earnings", screen: "staff", target: "referral-earnings", title: "Track referrals", body: "Referral commission uses the configured rate for referred bookings." },
    { id: "calculation-trace", screen: "staff", target: "calculation-trace", title: "Explain the number", body: "Calculation traces show the base, rate, earned amount, and payment status." },
  ] },
  { id: "month-end", title: "Financial Position and Month End", summary: "Balance, close, and reopen periods responsibly.", steps: [
    ...
    { id: "month-end", screen: "financial-position", target: "month-end", title: "Close the month", body: "Complete the month-end checks before closing." },
    { id: "reopen-period", screen: "financial-position", target: "reopen-period", title: "Reopen with a reason", body: "A closed period can be reopened only for a real correction and a recorded reason." },
  ] },
  { id: "reports", title: "Reports and Tax", summary: "Read reports and the approved tax estimate.", steps: [
    ...
    { id: "tax-guidance", screen: "settings", target: "tax-guidance", title: "Understand the estimate", body: "The individual-landlord rental-tax estimate: 12% of annual gross rental income above UGX 2,820,000." },
    { id: "excel-export", screen: "settings", target: "excel-export", title: "Share a workbook", body: "Export the checked report period to Excel when a workbook is needed." },
  ] },
  { id: "administration", title: "Administration and Safety", summary: "Maintain settings and secure local records.", steps: [
    ...
    { id: "effective-rates", screen: "settings", target: "effective-rates", title: "Date rate changes", body: "Effective-dated rates retain the calculation basis for historical periods." },
    { id: "backup", screen: "settings", target: "backup", title: "Create encrypted backups", body: "Back up regularly and store the encrypted copy separately." },
    { id: "restore", screen: "settings", target: "restore", title: "Restore deliberately", body: "Restore requires confirmation because it overwrites local data." },
    { id: "security", screen: "settings", target: "security", title: "Keep the password safe", body: "Storage is local only, and the business owner is responsible for the password." },
  ] },
];
