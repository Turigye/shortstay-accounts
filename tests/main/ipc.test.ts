...
describe("IPC contract", () => {
  ...
  it("registers only named channels", () => {
    ...
    expect([...handlers.keys()]).toEqual([
      ...
      IPC_CHANNELS.RECURRING_EXPENSE_ADVANCE,
      IPC_CHANNELS.FINANCE_OVERVIEW,
      IPC_CHANNELS.BALANCE_SAVE,
      IPC_CHANNELS.INVENTORY_SAVE,
      IPC_CHANNELS.ASSET_CREATE,
      IPC_CHANNELS.ASSET_UPDATE,
      IPC_CHANNELS.ASSET_ARCHIVE,
      IPC_CHANNELS.LOAN_CREATE,
      IPC_CHANNELS.LOAN_UPDATE,
