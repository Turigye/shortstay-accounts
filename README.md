...
Download the current [Short-Stay Accounts v0.3.0 Windows installer](https://github.com/Turigye/shortstay-accounts/releases/download/v0.3.0/Short-Stay.Accounts-0.3.0.Setup.exe).

Installing v0.3.0 over an earlier version keeps the existing encrypted local business file, password, bookings, reports, and settings. The update adds local Admin/Editor profiles and printable payment receipts. Create an encrypted backup before any software update as normal operating practice.
